...
SWIFT_CLASS("_TtC16FlowCoordinators11AppDelegate")
...
SWIFT_CLASS("_TtC16FlowCoordinators23FollowersViewController")
...
SWIFT_CLASS("_TtC16FlowCoordinators23FollowingViewController")
...
SWIFT_CLASS("_TtC16FlowCoordinators19LoginViewController")
...
SWIFT_CLASS("_TtC16FlowCoordinators18NavigationAnimator")
@interface NavigationAnimator : NSObject <UIViewControllerAnimatedTransitioning>
@property (nonatomic) UINavigationControllerOperation operation;
@property (nonatomic) CGFloat dampening;
...
SWIFT_CLASS("_TtC16FlowCoordinators28NavigationControllerDelegate")
...
@interface NavigationControllerDelegate (SWIFT_EXTENSION(FlowCoordinators)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC16FlowCoordinators22PasswordViewController")
...
SWIFT_CLASS("_TtC16FlowCoordinators21ProfileViewController")
@interface ProfileViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLayoutSubviews;
- (IBAction)settingsAction:(id _Nonnull)sender;
- (IBAction)followingAction:(id _Nonnull)sender;
- (IBAction)followersAction:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC16FlowCoordinators22SettingsViewController")
@interface SettingsViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)dismissViewControllerWithSender:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC16FlowCoordinators20SignupViewController")
@interface SignupViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (IBAction)nextActionWithSender:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end

@class UIPresentationController;

SWIFT_CLASS("_TtC16FlowCoordinators21TransitioningDelegate")
